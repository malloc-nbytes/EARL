...
*NOTE*: Do not modify the README.html as it is auto generated from README.org by Emacs Org Mode.
...
Now that the initial setup has been complete, you no longer have to use =autoconf=.
...
** TODO Pair *DEPRECATED*

** TODO Hashtbl *DEPRECATED*
