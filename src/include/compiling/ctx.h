...
int ctx_var_in_scope(ctx_t *ctx, struct cc *cc, const char *id);

/// @brief Assert that a variable is in scope
/// @note Will panic if it does not exist
/// @param ctx The context
/// @param id The ID
void ctx_assert_var_in_scope(ctx_t *ctx, struct cc *cc, const char *id);

/// @brief Assert that a variable is not in scope
/// @note Will panic if it does exist
/// @param ctx The context
/// @param id The ID
void ctx_assert_var_not_in_scope(ctx_t *ctx, struct cc *cc, const char *id);
