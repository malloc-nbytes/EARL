...
#+begin_quote
Documentation Comments allow you to embed help information into functions, enums, and classes.
The information can be retrieved by calling the intrinsic function =help()= on the appropriate
identifier.

*Note*: When using these, a function, enum, or class *must* be immediately after it.
#+end_quote
